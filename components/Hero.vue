    ...
    <header class="h-24 sm:h-32 flex items-center z-30 w-full">
      <div class="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          ...
          <span class="text-xs ml-3 mt-1"> CHARLIE-PRO@DESIGN.COM </span>
        </div>
        <div class="flex items-center">
          <nav
            class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden"
          >
            <a href="#" class="py-2 px-6 flex hover:text-black"> Works </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> Resume </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> Services </a>
