<template>
  ...
  >
    <div class="hidden md:block absolute -bottom-32 -left-32 w-96 h-96">
      <div
        class="absolute text-extrabold text-xl right-12 z-20 text-start top-1/4"
      >
    ...
    <header class="h-24 sm:h-32 flex items-center z-30 w-full">
      <div class="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          <MailIcon size="2x" />
          <span class="text-xs ml-3 mt-1"> mambobryan@gmail.com</span>
        </div>
        <div class="flex items-center">
          <nav
            class="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden"
          >
            <a href="#" class="py-2 px-6 flex hover:text-black"> Projects </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> Experience </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> About </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> Contact </a>
            <a href="#" class="py-2 px-6 flex hover:text-black"> FAQ </a>
          </nav>
    ...
    <div class="flex relative z-20 items-center">
      ...
      >
        <div class="flex flex-col">
          ...
          >
            Android Developer, building to Inspire.
          </h2>
          <div class="flex items-center justify-center mt-4">
            <a
              href="#"
              class="uppercase py-2 my-2 px-4 md:mt-16 bg-transparent dark:text-gray-800 dark:bg-white hover:dark:bg-gray-100 border-2 border-gray-800 text-gray-800 dark:text-white hover:bg-gray-800 hover:text-white text-md transition-all"
            >
              CONNECT WITH ME
            </a>
          </div>
